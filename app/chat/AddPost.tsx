...
export default function AddPost(): JSX.Element {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (loading) return;
    if (content.length === 0 || !previewUrl) return;
    setLoading(true);
    setError(false);
    ...
    <form onSubmit={handleSubmit} className="w-full">
      ...
      <div className="flex items-center mt-2">
        ...
        <button
          ...
          className="bg-gradient-to-r from-blue-400 to-gray-300 hover:from-pink-500 hover:to-yellow-500 text-white font-bold py-2 px-4 rounded-md ml-2"
